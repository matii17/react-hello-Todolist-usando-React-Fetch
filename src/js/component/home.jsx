...
const Home = () => {
  ...
  // Función para eliminar todas las tareas desde la API
  const handleDeleteAllTasksFromAPI = async () => {
    try {
      const response = await fetch(apiUrl, {
        method: 'DELETE',
        headers: {
      ...
      setTasks([]); // Limpiar las tareas en el estado local después de eliminarlas de la API
      console.log('Todas las tareas han sido eliminadas desde la API');
    } catch (error) {
      console.error('Error eliminando las tareas desde la API:', error);
      setError('Error eliminando las tareas desde la API: ' + error.message);
    }
  };
  ...
  return (
    <div className="container">
      ...
      <div className="button-container">
        <button onClick={handleLoadTasks}>Cargar Tareas</button>
        <button onClick={handleClearTasks}>Limpiar Tareas</button>
        <button onClick={handleDeleteAllTasksFromAPI}>Eliminar Todas las Tareas</button>
      </div>
    </div>
  );
};
